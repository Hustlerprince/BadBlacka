...
Run `hugo`. It will generate a folder called public. You can use the files in public folder for deployment. You should delete the public folder for each time when you are using `hugo` command.
